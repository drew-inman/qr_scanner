...
import 'package:qr_scanner/features/scanner/ui/widgets/scanner_bottom_sheet.dart';

void main() {
  group('ScannerBottomSheet', () {
    testWidgets('shows placeholder in initial state', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: ScannerBottomSheet(state: ScannerInitial()),
          ),
        ),
      );
      await tester.pump();
    ...
    testWidgets('shows placeholder in scanning state with no result',
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: ScannerBottomSheet(state: ScannerScanning()),
          ),
        ),
      );
      await tester.pump();
